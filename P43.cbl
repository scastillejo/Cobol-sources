      ...
      ********************************************
       ...
       INICIO.
           DISPLAY " " ERASE 
           MOVE "ABMC DE CURSOS" TO W-TITULO-ENC.
       ...
       100-LEOALUMNOS-00.
           OPEN I-O ALUMNOS.
           READ ALUMNOS KEY IS ALU-CODIGO-CURSO
              INVALID KEY
                MOVE "N" TO EXISTE
              NOT INVALID KEY
                MOVE "S" TO EXISTE
       ...
       100-ALTA-00.
           DISPLAY " " ERASE
           MOVE "ALTA DE CURSOS" TO W-TITULO-ENC
           PERFORM ENCABEZADO THRU ENCABEZADO-F
       ...
       200-BAJA-00.
           DISPLAY " " ERASE
           MOVE "BAJA DE CURSOS" TO W-TITULO-ENC
           PERFORM ENCABEZADO THRU ENCABEZADO-F
           PERFORM PANTALLA THRU PANTALLA-F.
       200-BAJA-10.
           ACCEPT CODIGO LINE 5 POSITION 13 PROMPT.
           ...
           IF EXISTE = "N"
             ...
             GO TO 200-BAJA-10
           END-IF.
           MOVE CODIGO TO ALU-CODIGO-CURSO
           PERFORM 100-LEOALUMNOS-00 THRU 100-LEOALUMNOS-99
           IF EXISTE = "S"
             MOVE "EL CURSO SE ENCUENTRA EN ALUMNOS." TO M-ERROR
             PERFORM ERRORES THRU ERRORES-F
             GO TO 200-BAJA-10
           END-IF.
       200-BAJA-20.
           MOVE REG-CURSOS TO W-DATOS
       ...
       300-MODIFICACION-00.
           DISPLAY " " ERASE
           MOVE "MODIFICACION DE CURSOS" TO W-TITULO-ENC
           PERFORM ENCABEZADO THRU ENCABEZADO-F
           PERFORM PANTALLA THRU PANTALLA-F.
       300-MODIFICACION-10.
           ACCEPT CODIGO LINE 5 POSITION 13 PROMPT.
       ...
       400-CONSULTA-00.
           DISPLAY " " ERASE
           MOVE "CONSULTA DE CURSOS" TO W-TITULO-ENC
           PERFORM ENCABEZADO THRU ENCABEZADO-F.
